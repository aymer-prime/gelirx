              ...
              children: [
                Row(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsets.symmetric(horizontal: AppPadding.p24.w),
                      child: Container(
                        decoration: BoxDecoration(
                          border: Border(
                            bottom: BorderSide(
                                width: 1, color: ColorManager.joyColor),
                          ),
                        ),
                        child: Text('Cancel',
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                ...
                                minimumSize:
                                    const Size(AppSize.s170, AppSize.s45),
                              ),
                              onPressed: () {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Business Bay, Silver Tower 9 floor 904, Dubai',
                              style: getTextStyle(AppSize.s14, FontWeight.w400,
                                  ColorManager.white)),
                        ],
                      ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Request Details',
                        style: getTextStyle(FontSizeManager.s24,
          ...
          children: [
            ...List.generate(stepCount, (index) {
              return Container(
                ...
                decoration: BoxDecoration(
                  color:
                      index > activeStep ? Colors.grey : ColorManager.joyColor,
      ...
      Positioned(
        ...
        child: Padding(
          padding: EdgeInsets.only(
            left: (activeStep * width / 5) + width / 16,
          ),
